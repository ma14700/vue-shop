<template>
  <div class="refunddetail">
        ...
        <h2>退款金额<span>¥{{(orderInfo.orderTotalAmount-orderInfo.couponAmount) | two}}</span></h2>
            <ul class="refund-flow" >
                ...
                <li>
                    ...
                    <p>银行受理</p> 
                    <span v-if="orderPress.length>5 && orderInfo.orderStatus >= 104">{{orderPress[5].happendTime | date}}</span>
                </li>
                <li>
                    <i :class="[(orderInfo.orderStatus >= 105)?'red-bg':'']"></i>
                    <b :class="[(orderInfo.orderStatus >= 105)?'red-bg':'']"></b>
                    <p>退款成功</p>
                    <span v-if="orderPress.length>6 && orderInfo.orderStatus >= 105">{{orderPress[6].happendTime | date}}</span>
                </li>
            </ul>
      ...
      <div class="wrp">
        ...
        <ul class="refund-reason" v-if="orderInfo.orderStatus>=102">
