  ...
  <div>
      <div class="order-good">
            ...
            <ul class="reason-detail">
                ...
                <li>退款说明<input type="text" placeholder="必填" v-model="remark"></li>
            </ul>
            ...
            <div class="btm-submit" @click="submitRefund">
                提交
            </div>
    ...
    submitRefund(){
      ...
      if(this.reasonText == "请选择"){
        Toast({
          ...
          this.$http.post("/api/neworder/refund/" + this.$route.query.id ,{
          ...
          MessageBox({
              title: '申请退款',
              message:'<p class="lh54">'+res.data.message+'</p>' ,
